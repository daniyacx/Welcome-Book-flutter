...
class AppTheme {
  static final _core = AppCoreTheme(
    shadowSub: Color.fromARGB(255, 221, 187, 13).withAlpha(100),
    primary: Color.fromARGB(255, 221, 187, 13),
    primaryLight: Color.fromARGB(255, 221, 187, 13).withAlpha(100),
    textSub: Color.fromARGB(255, 20, 20, 20),
