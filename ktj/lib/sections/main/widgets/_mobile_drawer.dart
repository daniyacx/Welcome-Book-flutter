...
class _MobileDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Drawer(
      child: Material(
        color: appProvider.isDark ? Color.fromARGB(255, 167, 208, 235) : Colors.white,
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                trailing: Switch(
                  inactiveTrackColor: Color.fromARGB(255, 139, 174, 199),
              ...
              Padding(
                ...
                child: MaterialButton(
                  ...
                  child: const ListTile(
                    leading: Icon(
                      Icons.book,
                      color:Color.fromARGB(255, 221, 187, 13),
                    ),
                    title: Text(
                      'Подробнее',
                    ),
